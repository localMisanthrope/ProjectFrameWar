...
{
    [Autoload(false)]
    internal class Neuroptics(string frameName) : ModItem
    {
        protected override bool CloneNewInstances => true;

        public override string Texture => "ProjectFrameWar/res/texture/warframes/part_Neuroptics";

        private readonly string frameName = frameName;

        public override string Name => $"Neuroptics_{frameName}";
